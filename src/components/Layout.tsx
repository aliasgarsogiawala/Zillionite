      ...
      <footer className="w-full bg-gray-800 text-white py-6 mt-12">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6 mt-4">
            <Link href="https://www.youtube.com/channel/UCZ9xEshbhWnyI7MgsfIKexA" target="_blank" className="text-gray-400 hover:text-white text-2xl">
              <FaYoutube />
            </Link>
            <Link href="https://www.linkedin.com/company/zillionite/posts/" target="_blank" className="text-gray-400 hover:text-white text-2xl">
              <FaLinkedin />
            </Link>
            <Link href="mailto:lead@zillionite.com" className="text-gray-400 hover:text-white text-2xl">
              <FaEnvelope />
            </Link>
          </div>
        </div>
