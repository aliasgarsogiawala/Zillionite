            ...
            >
              ...
              >
                <p className="italic text-lg font-medium text-gray-800">
                  If you are struggling with these Lingering Questions to build the biz of your dreams.
                </p>
                <p className="font-bold text-xl text-purple-700">
                  &ldquo;Developing Leaders&rdquo; is the Strategic Force for your business.
                </p>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-6">
                  {[
                    "Build Your Business from 0 to 1 Methodically",
                    "Worksheets for Customized Answers for your Business",
                    "Encompassing all domains of Business",
                    "Step by Step Approach to Design Your Business Idea",
                  ].map((benefit, index) => (
